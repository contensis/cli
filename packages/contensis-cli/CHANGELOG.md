...
* allow commit message as environment var in `push block` command ([4b821ee](https://github.com/contensis/cli/commit/4b821ee8af5b7350f3685b00d7a43a8377e1916e))
...
* erroneous exit codes ([5b13e2d](https://github.com/contensis/cli/commit/5b13e2d12f6e7a31bd8954ca15734adb5a15b55c))
...
* map `CONTENSIS_*` environment vars in `push block` command for use in CI workflows ([629f844](https://github.com/contensis/cli/commit/629f844accaa336922592c62beb953fea5f08398))
...
* supply a renderer by its friendly id or name in `set node renderer` ([1630d12](https://github.com/contensis/cli/commit/1630d1292a398679e4b73f42d5e200cbad501b51))
